...
function GradualBlur(props) {
  ...
  const containerStyle = useMemo(() => {
    ...
    if (isVertical) {
      ...
      baseStyle.width = responsiveWidth || config.width || responsiveHeight;
        ...
        {config.tint && (
          <div
            style={{
              ...
              inset: 0,
              pointerEvents: 'none',
              background: `linear-gradient(${getGradientDirection(config.position)}, transparent 0%, ${config.tint} 100%)`,
              opacity: config.opacity,
              zIndex: 2
            }}
          />
